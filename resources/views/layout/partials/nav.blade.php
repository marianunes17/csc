<div id="navbar" role="navigation" class="navbar navbar-expand-lg">
    <div class="container"><a href="{{route('csc.index')}}" class="navbar-brand home">
            <img src="img/logos/logo-simbolo.png" alt="Centro Social de
                Carnide logo"
                class="d-none d-md-inline-block logo"> <span
                class="site-description">Centro Social de Carnide</span>
        </a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-2">
                                    ...
                                    <ul class="list-unstyled mb-3">
                                        <li class="nav-item">
                                            <a href="{{route('csc.historia')}}"
                                                class="nav-link">História</a>
                                        </li>

                                        <li class="nav-item">
                                            <a href="{{route('csc.equipa')}}"
                                                class="nav-link">Equipa</a>
                                        </li>

                                        <li class="nav-item">
                                            <a href="{{route('csc.parcerias')}}"
                                                class="nav-link">Parcerias</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
